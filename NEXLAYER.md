...
**Live:** [https://relaxed-weasel-wordpress.cloud.nexlayer.ai](https://relaxed-weasel-wordpress.cloud.nexlayer.ai)  
...
**wordpress** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/library/wordpress:6.4-apache
    path: /
    servicePorts:
    - 80
    vars:
      WORDPRESS_DB_HOST: wordpress-db.pod:3306
